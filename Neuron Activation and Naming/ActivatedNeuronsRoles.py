...
# --- Configuration ---
SAE_MODEL_PATH = 'SAE_cropped_artifacts/sae_model_fold_3.pt'
EMBEDDING_DIR = 'cropped_embedding_artifacts'
OUTPUT_JSON_FILE = 'activated_neurons_to_embeddings_roles.json'
...
def map_neurons_to_embeddings():
    ...
    input_dim = 512  # Image-only CLIP feature dimension
